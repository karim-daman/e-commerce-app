<footer class="bg-white">
    ...
    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
      <div class="flex flex-col items-center justify-between gap-2 md:flex-row">
        ...
        <div class="flex w-full gap-2 md:max-w-md">
          ...
          <button
            class="inline-block rounded bg-white px-8 py-2 text-center text-sm font-semibold text-indigo-500 outline-none ring-indigo-300 transition duration-100 hover:bg-gray-100 focus-visible:ring active:text-indigo-600 md:text-base"
            >Send</button>
        </div>
      </div>
    </div>
  ...
  <div class="pt-12 lg:pt-16">
    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
      ...
      <div class="border-t py-8 text-center text-sm text-gray-400">© {new Date().getFullYear()} . All rights reserved.</div>
    </div>
  </div>
</footer>
