...
<div
	class="relative min-w-[120px] border border-l-0 border-[#ced4da]"
	use:clickOutside={onEscape}
>
	<button
		class="font-normal grid grid-flow-col items-center justify-center text-left text-black/80 text-[15px] w-full h-full"
		type="button"
		on:click={onClick}
	>
		{choices[selected]}
