...
<div class="relative text-black/50 hover:text-black/80 transition-colors {$$props.class}">
  <button class="font-normal text-[15px] flex items-center gap-1 justify-items-center" type="button" on:click={onClick}>
    <slot />
