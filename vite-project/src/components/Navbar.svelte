<script>
  ...
  let unsubscribe = authStore.subscribe((crr) => {
    user = crr.currentUser;
  });
...
<Navbar class="fixed bg-teal-500 backdrop-blur-sm bg-opacity-40 z-10" let:hidden let:toggle>
  <NavBrand href="/">
  ...
  <button class="flex items-center md:order-2">
    <img
      class="h-10 bg-slate-300 rounded-full border border-gray-100 shadow-sm"
      src={user ? (user.providerData[0].photoURL ? user.providerData[0].photoURL : "/avatar.svg") : "/avatar.svg"}
      alt="avatar"
      id="avatar-menu" />
  ...
  <Dropdown placement="bottom" triggeredBy="#avatar-menu">
    {#if usermail}
      ...
      <DropdownItem on:click={authHandlers.logout} class="flex">
    ...
    {:else}
      <DropdownItem on:click={() => openAuthModal(false)} class="flex">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-3">
          <path
            stroke-linecap="round"
            stroke-linejoin="round"
        ...
        Login</DropdownItem>
      <DropdownItem on:click={() => openAuthModal(true)} class="flex">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-3">
          <path
            stroke-linecap="round"
            stroke-linejoin="round"
