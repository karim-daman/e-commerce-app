...
<div class="md:hidden relative">
  <button class="flex justify-between items-center w-full rounded-[.25rem] border border- p-[10px]" on:click={onClick}>
    My Markets
...
<div class="tablet-scroll hidden md:grid overflow-y-scroll max-h-full grid-flow-row auto-rows-max">
  <h1 class="font-bold uppercase tracking-tight mb-1 text-black/90">My Markets</h1>
