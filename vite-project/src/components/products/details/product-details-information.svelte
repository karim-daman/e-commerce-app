...
<p>Description: Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. ipsum dolor sit amet, consectetur adipiscing elit.</p>
...
<table class="grid grid-cols-[max-content,1fr] items-center gap-2 my-2">
  ...
  <td class="justify-self-end">
    <dd class="flex h-10">
      <button class=" shadow-xl active:shadow-none h-10 w-10 flex flex-row mx-px text-black px-[10px] mb-4 py-[7px] rounded-[.25rem] border" use:hold={qty_decrement}>
      ...
      <button class="shadow-xl active:shadow-none h-10 w-10 flex flex-row mx-px text-black px-[10px] mb-4 py-[7px] rounded-[.25rem] border" use:hold={qty_increment}>
