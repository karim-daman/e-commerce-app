<script>
  ...
  import LostCredentialsModal from "./LostCredentialsModal.svelte";
  ...
  function closeAuthModal() {
    ...
    $authModalStore = isLoading = $isPasswordLost = false;
  }
  ...
  async function lostPassword() {
    //
    "EMAIL MUST BELONG TO A VERIFIED ACCOUNT BEFORE SENDING A LINK";
    //
    ...
    {:else}
      <form class="flex flex-col space-y-6" action="#">
        ...
        <div class="flex items-start">
          ...
          {#if !authType}
            <!-- <button on:click={lostPassword} class="ml-auto text-sm text-blue-700 hover:underline dark:text-blue-500">Lost password?</button> -->
            <button
              on:click={() => {
                $isPasswordLost = true;
              }}
        ...
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded drop-shadow-lg active:drop-shadow-none" on:click={handleSubmit}>
      ...
      <div class="flex">
        <button
          ...
          class="m-1 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-4">
